...
import * as commentsServices from '../features/comments/comments';
...
export const PostDetails: React.FC<Props> = ({ post }) => {
  ...
  useEffect(() => {
    ...
    dispatch(commentsServices.loadPostComments(post.id));
  }, [post, dispatch]);
  ...
  const addComment = async ({ name, email, body }: CommentData) => {
    ...
    await dispatch(commentsServices.createComment(newComment));
  };
              ...
              >
                <div className="message-header">
                  ...
                  <button
                    ...
                    aria-label="delete"
                    onClick={() => handleDeleteCommentBy(comment.id)}
                  >
                    delete button
                  </button>
                </div>
